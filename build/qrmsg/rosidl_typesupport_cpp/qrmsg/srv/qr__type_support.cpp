...
static const _Qr_Request_type_support_symbol_names_t _Qr_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, qrmsg, srv, Qr_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, qrmsg, srv, Qr_Request)),
  }
};
...
{
  return &::qrmsg::srv::rosidl_typesupport_cpp::Qr_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, qrmsg, srv, Qr_Request)() {
  return get_message_type_support_handle<qrmsg::srv::Qr_Request>();
}
...
static const _Qr_Response_type_support_symbol_names_t _Qr_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, qrmsg, srv, Qr_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, qrmsg, srv, Qr_Response)),
  }
};
...
{
  return &::qrmsg::srv::rosidl_typesupport_cpp::Qr_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, qrmsg, srv, Qr_Response)() {
  return get_message_type_support_handle<qrmsg::srv::Qr_Response>();
}
...
static const _Qr_type_support_symbol_names_t _Qr_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, qrmsg, srv, Qr)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, qrmsg, srv, Qr)),
  }
};
...
{
  return &::qrmsg::srv::rosidl_typesupport_cpp::Qr_service_type_support_handle;
}
