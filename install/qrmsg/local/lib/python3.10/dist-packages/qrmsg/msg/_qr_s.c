...
bool qrmsg__msg__qr__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("qrmsg.msg._qr.Qr", full_classname_dest, 16) == 0);
  }
  qrmsg__msg__Qr * ros_message = _ros_message;
  {  // num
...
{
  /* NOTE(esteve): Call constructor of Qr */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("qrmsg.msg._qr");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Qr");
