...
static rosidl_typesupport_introspection_c__MessageMember qrmsg__srv__Qr_Request__rosidl_typesupport_introspection_c__Qr_Request_message_member_array[2] = {
  {
    "num",  // name
...
static rosidl_typesupport_introspection_c__MessageMember qrmsg__srv__Qr_Response__rosidl_typesupport_introspection_c__Qr_Response_message_member_array[2] = {
  {
    "finish",  // name
